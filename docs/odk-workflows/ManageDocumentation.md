...
The documentation for NFDICORE is managed in two places (relative to the repository root):
...
4. If your development team likes your changes, merge the docs into odk branch.
...
2. Now you are ready to build the docs as follows:
   ...
   ```
   INFO    -  Your documentation should shortly be available at: https://ISE-FIZKarlsruhe.github.io/nfdicore/ 
   ```
3. Just to double check, you can now navigate to your documentation pages (usually https://ISE-FIZKarlsruhe.github.io/nfdicore/). 
