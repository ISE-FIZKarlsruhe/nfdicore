...
1) Locate your odk yaml file and open it with your favourite text editor (src/ontology/nfdicore-odk.yaml)
...
```
  <uri name="https://nfdi.fiz-karlsruhe.de/ontology/nfdicore/components/your-component-name.owl" uri="components/your-component-name.owl"/>
```

4) Add the component to the edit file (src/ontology/nfdicore-edit.obo)
for .obo formats: 

```
import: https://nfdi.fiz-karlsruhe.de/ontology/nfdicore/components/your-component-name.owl
```
...
6) In your custom makefile (src/ontology/nfdicore.Makefile) add a goal for your custom make file. In this example, the goal is a ROBOT template.
