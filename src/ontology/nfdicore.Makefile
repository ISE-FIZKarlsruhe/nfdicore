...
$(IMPORTDIR)/iao_import.owl: $(MIRRORDIR)/iao.owl 
	if [ $(IMP) = true ]; then $(ROBOT) query -i $< --update ../sparql/preprocess-module.ru \
		remove --term http://purl.obolibrary.org/obo/IAO_0020010 --preserve-structure false \
...
CITATION="'Jörg Waitelonis, Oleksandra Bruns, Tabea Tietz, Dilek Yargan, Etienne Posthumus, Hossein Beygi Nasrabadi, Harald Sack. NFDIcore Ontology. Revision: v$(VERSION). Retrieved from: https://nfdi.fiz-karlsruhe.de/ontology/$(VERSION)'"
